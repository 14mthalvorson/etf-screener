    ...
    def __init__(self, ticker):
        ...
        if self.ticker == 'ebitda':
            self.holdings = {'amzn': '10.00%', 'aapl': '10.00%', 'googl': '10.00%', 'fb': '10.00%',
                             ...
                             'apps': '10.00%', 'low': '10.00%', 'bmy': '10.00%', 'ups': '10.00%', 'pins': '10.00%',
                             'roku': '10.00%', 'xom': '10.00%', 'upst': '10.00%', 'nke': '10.00%', 'hd': '10.00%',
                             'now': '10.00%', 'acn': '10.00%', 'ibm': '10.00%', 'adsk': '10.00%', 'mime': '10.00%',
                             'dpz': '10.00%', 'tyl': '10.00%', 'logi': '10.00%', 'crm': '10.00%', 'hon': '10.00%',
