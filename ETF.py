        elif ticker == 'my_top':  # My Top Holdings
            self.ticker_string = 'googl amzn ubt tmf meta coin msft aapl crm shop crwd ttd se adbe nvda ddog veev sq pltr net now hubs fngg fngu bulz twlo etsy pins tdoc qqq'

        elif ticker == 'largest_us':  # Largest US
            self.ticker_string = 'aapl msft googl amzn tsla nvda meta v unh jnj jpm wmt pg ma bac hd xom cvx dis ko abbv pfe avgo lly cost csco adbe vz pep tmo nke cmcsa orcl abt crm dhr wfc intc mrk qcom amd ups mcd nflx t pm txn ms unp tmus nee rtx bmy low schw bx intu axp cvs hon amgn cop lmt pypl c amat now ba de ibm gs antm blk pld amt isrg sbux tgt chtr el abnb ge cat syk mu spgi mo zts mdlz bkng adp cme adi snow mmm usb pnc ci bdx mmc gild duk lrcx tjx hca tfc csx cci ice eog noc ew fcx so uber regn itw shw f eqix gm atvi mrna fisv d gd cl psa snap bsx nsc wm mco wday vrtx pgr cof pxd sq fis rivn fdx nem mrvl bto panw ftnt scco hum epd mar kdp emr met slb ilmn klac apd ddog lhx vmw kkr ecl cnc adsk rop snps khc crwd aig mpc dg ctsh sre idxx aep oxy spg aph orly coin syy iqv kmb adm mnst bax payx dow cmg dell zs cdns hsy bk msci exc stz lcid ttd mck dxcm algn kmi trv gis hlt pru ctas wba a o net dvn wmb dd mchp'
        ...
        # Finviz Sectors/Industries
            ...
            self.ticker_string = 'googl meta snap dash twlo mtch spot twtr yndx pins zg z iac grub yy carg lz angi sstk yelp ttgt seat cdlx tbla trvg'
            ...
            self.ticker_string = 'qqqm voog vht vdc vig msft vgt vpu vox goog ma v meta vxf aapl ihi amzn coin dlr eqix sbac tsm cci adbe amt crm xbi nflx'

        elif ticker == 'fngg':  # FNGG ETF Holdings
            self.ticker_string = 'googl amd meta nvda amzn msft aapl nflx rblx zs snap crwd se ddog nio snow u tsla zm shop'
            self.is_real_etf = True
            self.leverage = '2x'
            self.expense_ratio = '1.09%'

        elif ticker == 'fngs' or ticker == 'fngo' or ticker == 'fngu':  # FNGU ETF Holdings
            self.ticker_string = 'amzn aapl googl meta tsla twtr nvda nflx baba bidu'
            self.is_real_etf = True
            if ticker == 'fngs':
                self.leverage = '1x'
            ...
            self.ticker_string = 'aapl amd amzn crm meta googl intc msft mu nflx nvda pypl qcom sq tsla'
            self.is_real_etf = True
            self.expense_ratio = '0.95%'
            self.leverage = '3x'
        ...
        elif ticker == 'qqq' or ticker == 'qld' or ticker == 'tqqq' or ticker == 'qqqm':  # Hardcoded more than top 25 QQQ holdings
        ...
        elif ticker == 'spy' or ticker == 'sso' or ticker == 'upro' or ticker == 'voo' or ticker == 'splg' or ticker == 'ivv':  # Hardcoded more than top 25 SPY holdings
        ...
        elif ticker == 'xbi' or ticker == 'labu':  # Hardcoded more than top 25 XBI (Biotech) holdings
        ...
        elif ticker == 'fdn' or ticker == 'webl':
            ...
            self.weights = {'bx': '1.06%', 'snow': '0.89%', 'mrvl': '0.86%', 'uber': '0.83%', 'sq': '0.77%', 'abnb': '0.69%', 'panw': '0.65%', 'wday': '0.62%', 'snap': '0.60%', 'lulu': '0.55%', 'ddog': '0.55%', 'twlo': '0.53%', 'kkr': '0.52%', 'crwd': '0.50%', 'ttd': '0.48%', 'zm': '0.47%', 'net': '0.43%', 'veev': '0.42%', 'mdb': '0.42%', 'okta': '0.39%', 'csgp': '0.37%', 'hubs': '0.35%', 'pltr': '0.35%', 'on': '0.35%', 'docu': '0.33%', 'kdp': '0.32%', 'invh': '0.32%', 'avtr': '0.30%', 'zs': '0.30%', 'lbrdk': '0.29%', 'hznp': '0.29%', 'sui': '0.29%', 'dash': '0.29%', 'lng': '0.28%', 'vmw': '0.28%', 'u': '0.27%', 'bill': '0.27%', 'tru': '0.27%', 'roku': '0.25%', 'pins': '0.24%', 'alny': '0.24%', 'cvna': '0.24%', 'sgen': '0.23%', 'burl': '0.23%', 'zi': '0.23%', 'vici': '0.22%', 'entg': '0.22%', 'splk': '0.22%', 'moh': '0.22%', 'podd': '0.22%', 'pcg': '0.22%', 'cpt': '0.22%', 'ssnc': '0.21%', 'acgl': '0.20%', 'mkl': '0.20%', 'bldr': '0.20%', 'ally': '0.20%', 'dell': '0.19%', 'bmrn': '0.19%', 'rivn': '0.19%', 'apo': '0.19%', 'lcid': '0.19%', 'nuan': '0.19%', 'trex': '0.19%', 'rng': '0.18%', 'wpc': '0.18%', 'els': '0.18%', 'masi': '0.18%', 'fnf': '0.18%', 'afrm': '0.18%', 'tdoc': '0.17%', 'plug': '0.17%', 'rprx': '0.17%', 'cck': '0.17%', 'mpw': '0.17%', 'gddy': '0.17%', 'amc': '0.16%', 'fnd': '0.16%', 'cgnx': '0.16%', 'txg': '0.16%', 'ndsn': '0.16%', 'rgen': '0.16%', 'jll': '0.16%', 'ares': '0.16%', 'ggg': '0.16%', 'exas': '0.16%', 'elan': '0.16%', 'mtn': '0.16%', 'bg': '0.16%', 'rpm': '0.16%', 'w': '0.15%', 'csl': '0.15%', 'bki': '0.15%', 'lpla': '0.15%', 'lyft': '0.15%', 'zen': '0.15%', 'lsi': '0.15%', 'wsm': '0.15%', 'cube': '0.15%', 'amh': '0.15%', 'rexr': '0.15%', 'eqh': '0.15%', 'fwonk': '0.15%', 'wtrg': '0.15%', 'trgp': '0.14%', 'cien': '0.14%', 'dt': '0.14%', 'fico': '0.14%', 'coup': '0.14%', 'sci': '0.14%', 'stld': '0.14%', 'five': '0.14%', 'rrx': '0.14%', 'cone': '0.14%', 'bah': '0.13%', 'lbtyk': '0.13%', 'hubb': '0.13%', 'avlr': '0.13%', 'nly': '0.13%'}
            self.ticker_string = ticker
            self.is_real_etf = True

        elif ticker == 'vone':
            self.weights = {'aapl': '5.99%', 'msft': '5.54%', 'amzn': '3.16%', 'googl': '3.67%', 'tsla': '1.87%', 'fb': '1.74%', 'nvda': '1.54%', 'brk.b': '1.20%', 'unh': '1.03%', 'jpm': '1.02%', 'jnj': '0.98%', 'hd': '0.96%', 'pg': '0.86%', 'v': '0.80%', 'pfe': '0.72%', 'bac': '0.70%', 'ma': '0.69%', 'dis': '0.61%', 'adbe': '0.59%', 'csco': '0.59%', 'avgo': '0.58%', 'acn': '0.58%', 'tmo': '0.57%', 'nflx': '0.57%', 'xom': '0.57%', 'cost': '0.55%', 'abt': '0.53%', 'pep': '0.52%', 'abbv': '0.52%', 'crm': '0.52%', 'lly': '0.51%', 'ko': '0.50%', 'cmcsa': '0.50%', 'cvx': '0.50%', 'pypl': '0.48%', 'vz': '0.47%', 'dhr': '0.46%', 'intc': '0.45%', 'wmt': '0.45%', 'nke': '0.45%', 'qcom': '0.45%', 'mcd': '0.44%', 'mrk': '0.42%', 'wfc': '0.42%', 'nee': '0.40%', 'low': '0.39%', 't': '0.38%', 'amd': '0.38%', 'txn': '0.38%', 'intu': '0.37%', 'unp': '0.35%', 'ups': '0.34%', 'pm': '0.32%', 'hon': '0.32%', 'orcl': '0.31%', 'amat': '0.31%', 'bmy': '0.30%', 'mdt': '0.30%', 'sbux': '0.30%', 'cvs': '0.30%', 'amt': '0.29%', 'ms': '0.29%', 'blk': '0.29%', 'rtx': '0.28%', 'now': '0.28%', 'amgn': '0.28%', 'isrg': '0.28%', 'schw': '0.28%', 'gs': '0.27%', 'pld': '0.27%', 'c': '0.26%', 'ibm': '0.26%', 'zts': '0.25%', 'spgi': '0.25%', 'antm': '0.25%', 'tgt': '0.25%', 'cat': '0.24%', 'ba': '0.24%', 'adp': '0.23%', 'mu': '0.23%', 'ge': '0.23%', 'axp': '0.22%', 'mmm': '0.22%', 'lrcx': '0.22%', 'bkng': '0.21%', 'de': '0.21%', 'cop': '0.21%', 'adi': '0.21%', 'syk': '0.20%'}
            self.ticker_string = ticker
            self.is_real_etf = True

        elif ticker == 'vwo':
            self.weights = {'baba': '2.57%', 'bidu': '0.50%', 'bili': '0.14%', 'fsr': '0.23%', 'gfi': '0.12%', 'infy': '1.10%', 'li': '0.16%', 'mtn': '0.24%', 'nio': '0.49%', 'pdd': '0.27%', 'sm': '0.11%', 'sol': '0.11%', 'tcom': '0.16%', 'tcs': '0.63%', 'tsm': '1.49%', 'umc': '0.12%', 'xpev': '0.30%'}
            self.ticker_string = ticker
            self.is_real_etf = True
        ...
        if self.is_real_etf:
            ...
            try:
                ...
                self.three_year_return, self.five_year_return, self.ten_year_return = None, None, None
            ...
            try:
                ...
                for metric_title in columns:
                    try:
                        ...
                        if metric_title == 'Cur/His P/S Ratio':
                            line += component.current_to_historical_ps_ratio + '\t'
                        ...
                        if metric_title == '1 Year Return':
                            line += component.perf_year + '\t'
                        if metric_title == '3 Year Return':
                            line += component.three_year_return + '\t'
                        if metric_title == '5 Year Return':
