...
class ETF:
    ...
    def __init__(self, ticker):
        ...
        # Only include in the list if evaluating this stock with this metric is a decent valuation method.
            ...
            ticker_string = 'wmt amzn aapl unh cvs tm xom googl cost msft t ci tte hd jd cvx f lfc vz antm bp gm ' \
        ...
        elif self.etf_ticker == 'letf':  # GP relevant companies
            ticker_string = 'qqq qld tqqq tecl bulz rom fngu upro sso fngg iyw fngo fngs spy vpn'
            self.set_holdings_from_string(ticker_string)
